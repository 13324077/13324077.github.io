...
通过python语言实现logistic regression算法，
...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  7 22:31:04 2018
...
"""
2 - Building the Logistic Regression
"""
...
def logistic_regression_model(X_train, Y_train, X_test, Y_test, num_iterations = 2000, learning_rate = 0.5, print_cost = False):
    ...
    # 4. Predict test/train set example
...
其中load_dataset()函数的实现如下，读取.h5文件中数据内容
